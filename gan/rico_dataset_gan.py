...
def generator(z, batch_size, z_dim):
    g_w1 = tf.get_variable('g_w1', [z_dim, 6220800], dtype=tf.float32, initializer=tf.truncated_normal_initializer(stddev=0.02))
    g_b1 = tf.get_variable('g_b1', [6220800], initializer=tf.truncated_normal_initializer(stddev=0.02))
    g1 = tf.matmul(z, g_w1) + g_b1
    g1 = tf.reshape(g1, [-1, 1920, 1080, 3])
    ...
    g2 = tf.nn.relu(g2)
    g2 = tf.image.resize_images(g2, [1920, 1080])
    ...
    g3 = tf.nn.relu(g3)
    g3 = tf.image.resize_images(g3, [1920, 1080])
...
x_placeholder = tf.placeholder(tf.float32, shape = [None,960,540,3], name='x_placeholder') 
